            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="{{ route('detallesinventario.create') }}">Registrar productos</a></li>
                        <li class="nav-item"><a class="nav-link" href="/detallesinventario">Mi inventario</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="row d-flex justify-content-center" styles="ali">
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Vladimir López Twitter Profile"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/vladimir.lopezreynoso/" aria-label="Vladimir López Facebook Profile"><i class="fab fa-facebook-f"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <h4>Manuel García</h4>
                            <p class="text-muted">Estudiante INCO</p>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Manuel García Twitter Profile"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/profile.php?id=100006961060292" aria-label="Manuel García Facebook Profile"><i class="fab fa-facebook-f"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 my-3 my-lg-0">
                        <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/pixanstudio3d?igsh=b2hlMG5qbTJyMnJo" aria-label="Twitter"><i class="fab fa-instagram"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/pixanstudio/photos" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                    </div>
